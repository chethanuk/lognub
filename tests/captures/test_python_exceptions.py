...
from lognub.captures import python_exceptions

# DEFAULT_EXCEPTHOOK = copy.deepcopy(sys.excepthook)


@pytest.mark.skip("TODO: Need to fix - TypeError: cannot serialize 'EncodedFile' object")
...
@pytest.mark.skip("TODO: Need to fix - TypeError: cannot serialize 'EncodedFile' object")
@patch("lognub.captures.python_exceptions._ORIGINAL_EXCEPTHOOK")
