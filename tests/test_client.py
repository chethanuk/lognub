...
from lognub.client import LOGGER_DEFAULT_CONFIG, configure_logger, get_logger, log_instance


@patch("lognub.client.loguru.logger.configure")
...
@patch("lognub.captures.python_warnings.capture")
@patch("lognub.captures.python_warnings.release")
...
@patch("lognub.captures.python_exceptions.capture")
@patch("lognub.captures.python_exceptions.release")
...
@patch("lognub.handles.propagate_handler.PropagateHandler.add_handle")
@patch("lognub.handles.propagate_handler.PropagateHandler.remove_handle")
...
@patch("lognub.handles.intercept_handler.InterceptHandler.add_handle")
@patch("lognub.handles.intercept_handler.InterceptHandler.remove_handle")
...
@patch("lognub.client.patch_logger")
